...
public class KakaoMapClient {
    ...
    public KakaoMapDto getRoute(String origin, String destination) {
    ...
    private KakaoMapDto extractDistanceAndDuration(Map<String, Object> responseBody) {
        try {
            ...
            return new KakaoMapDto(distance, duration);
        } catch (Exception e) {
